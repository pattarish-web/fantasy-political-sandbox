...
chars = [
    {
        ...
        'meta': {
            ...
            'gender': 'ชาย', 'sexuality': 'เฮเทอโรเซ็กชวล (Heterosexual) - ดึงดูดผู้ที่มีเพศตรงข้าม',
    ...
    },
    {
        ...
        'meta': {
            ...
            'gender': 'หญิง', 'sexuality': 'เอเซ็กชวล (Asexual) - ไม่มีความรู้สึกดึงดูดทางเพศต่อบุคคลอื่น สนใจเพียงแต่ภารกิจ',
    ...
    },
    {
        ...
        'meta': {
            ...
            'gender': 'หญิง', 'sexuality': 'ไบเซ็กชวล (Bisexual) - สามารถมีความรักและแรงดึงดูดทางเพศกับทั้งเพศชายและเพศหญิง',
    ...
    },
    {
        ...
        'meta': {
            ...
            'gender': 'ชาย', 'sexuality': 'แพนเซ็กชวล (Pansexual) - รู้สึกดึงดูดใจ ไม่ว่าจะเป็นความรักหรือทางเพศ ต่อผู้อื่นโดยไม่จำกัดเพศสภาพและอัตลักษณ์ทางเพศ',
    ...
    },
    {
        ...
        'meta': {
            ...
            'gender': 'หญิง', 'sexuality': 'เอเซ็กชวล (Asexual) - ไม่มีความรู้สึกดึงดูดทางเพศ หรือยังไม่เข้าใจความรู้สึกรักใคร่เพราะถูกเลี้ยงมาเป็นเครื่องจักรสังหาร',
    ...
    },
    {
        ...
        'meta': {
            ...
            'gender': 'ชาย', 'sexuality': 'พรหมจรรย์ (Celibate) - ละเว้นจากกิจกรรมทางเพศทุกชนิดเพื่ออุทิศตนให้ศาสนา',
    ...
    },
    {
        ...
        'meta': {
            ...
            'gender': 'ชาย', 'sexuality': 'โฮโมเซ็กชวล (Homosexual) - มีความรักและแรงดึงดูดต่อผู้ที่มีเพศเดียวกัน',
